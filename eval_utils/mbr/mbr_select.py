...
if __name__ == "__main__":
    ...
    for i in range(args.num):
        raw_data.append(open(f'./data/{args.data_name}/gen_data/gen{i}.txt', 'r').readlines())
    ...
    with open(f'./data/{args.data_name}/gen_{args.exp_name}.txt', 'w', encoding='utf-8') as wp:
